...
class Dijkstra:
    def __init__(self, nodes, links):
        self.nodes = nodes
        print(self.nodes['A119BS010143'].idx)
        self.links = links
        #TODO: (3) weight 값 계산
    ...
    def get_weight_matrix(self):
        ...
        for from_node_id, from_node in self.nodes.items():
            ...
            # print(from_node.get_to_nodes())
            for to_node in from_node.get_to_nodes():
                # print('mmmmmmmmmm')
                # print(to_node.idx)
                # print(to_node.point)
                # print(to_node.node_type)
                # print(to_node.on_stop_line)
                # print('mmmmmmmmmm')
                # print(len(from_node.get_to_nodes()))
    ...
    def find_shortest_link_leading_to_node(self, from_node,to_node):
        ...
        # print("mmmmmmmm")
        # print(from_node.get_to_nodes())
        # print(from_node.point[0]) # x
        # print(from_node.point[1]) # y
        # print(from_node.point[2]) # z
        # print("mmmmmmmm")
        # min_cost = sqrt(pow(from_node.point[0]-to_node.point[0],2) + pow(from_node.point[1]-to_node.point[1],2))
        # print(min_cost)
        # shortest_link = {}
        # for i in self.links :
        #     i.
        # print(self.links.from_node_idx)
        # print(self.links.to_node_idx)
        to_links = []
        # print('under from node')
        # print(from_node)
        # print()
        # print(from_node.get_to_links)
        # print('upper get_to_links')
        
        for link in from_node.get_to_links():
            # print(link.idx)
            # print()
            # print(link.to_node.idx)
        ...
        for link in to_links:
            test = sqrt((from_node.point[0]-to_node.point[0])**2 + (from_node.point[1]-to_node.point[1])**2)
