...
doc_ret_re_btn = db.collection(u'Reservation').document(u'return_btn') # connect db + return btn
            ...
            if self.is_path == True and self.is_odom == True and self.is_status == True:
                ...
                if forward_shortest_node.is_on_stop_line() == True:
                    ...
                    # 2-2. 다른 신호라서 통과 불가
                        ...
                        self.traffic_flag = 1
                        # traffic_dist = ((self.current_postion.x - temp.points[0][0])**2 + (self.current_postion.y - temp.points[0][1])**2)**0.5
                ...
                if self.is_look_forward_point :
                    ...
                    # ===============================================================================================
                    doc_ref_choice.set({u'choice_btn' : False})
                    doc_ref_reservation.set({u'reservation_btn' : False})
                    # return btn active
                    # doc_ret_re_btn.set({u'return_btn' : True})
                    # ===============================================================================================
