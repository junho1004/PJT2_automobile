...
class pure_pursuit :
    def __init__(self):
        ...
        # self.start_wait = self.Reservation.start_waiting_time.get().to_dict()["start_wait"]
        ...
        self.total_dist = self.Ego.total_distance.get().to_dict()["dist"]
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_path == True and self.is_odom == True and self.is_status == True:
                ...
                if self.total_dist > 0:
                   ...
                   if cnt % 30 == 0:
                    self.Ego.total_distance.set({u'dist' : 0})
                #========================================================#
                ...
                if forward_shortest_node.is_on_stop_line() == True:
                    ...
                    if self.is_traffic_light == True:

                        print(next_link_direction)

                        # if next_link_direction == None:
                        #     print("None")
                        #     self.traffic_flag = 0
                        ...
                        # 2-2. 다른 신호라서 통과 불가                   
                            ...
                            temp_traffic_info = [temp.points[0][0], temp.points[0][1], 0]
                            self.traffic_flag = 1
                            ...
                            tmp_det_t=np.array([[tmp_t[0][0], tmp_t[1][0], -(tmp_t[0][0] * tmp_translation[0] + tmp_t[1][0]*tmp_translation[1])],
                                                ...
                                                [0,0,1]])
                            global_result=np.array([[temp_traffic_info[0]], [temp_traffic_info[1]], [1]])
                            
                            local_result=tmp_det_t.dot(global_result)
                                    
                            local_traffic_info = [local_result[0][0], local_result[1][0], temp_traffic_info[2]]
                ...
                if self.is_look_forward_point :
                    ...
                    #========================================================#
                    # self.Reservation.choice_btn.set({u'choice_btn' : False})
                    # self.Reservation.reservation_btn.set({u'reservation_btn' : False})
                    #========================================================#
    ...
    def traffic_light_callback(self, data):
        ...
        #print(status)
        if status == 1: # Red
            self.possible_link_direction = ['right']
